...
function TechnicalHiddenDirection() {
  const topic = {
    n: "03",
    part: "I",
    ...
    prev: { title: "02 · Defects and Topological Stability" },
    next: { title: "04 · Throat Defects" },
  };
...
Object.assign(window, { TechnicalHiddenDirection });
