...
function PlainThroats() {
  const topic = {
    ...
    prev: { title: "03 · A Hidden Direction" },
    next: { title: "05 · Gravity as Inflow" },
  };
    ...
    <TopicPage track="plain" topic={topic}>
      ...
      >
        ...
        <TPBody>
          ...
          Fluid Universe picture. They are two different geometric things a
      ...
      <TPSection anchor="caution" eyebrow="honest caveats" heading="What a throat is not.">
        ...
        <div style={{
          ...
          <span className="fu-small" style={{ color: "var(--ink-2)", flex: 1, minWidth: 220 }}>
            Distributed profile <em>R(Ω, w, t)</em>, boundary conditions at the mouth, and the moving-throat frontier.
          </span>
...
Object.assign(window, { PlainThroats });
