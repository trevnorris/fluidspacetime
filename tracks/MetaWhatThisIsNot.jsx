/* global React, TopicPage, TPTitle, TPLede, TPSection, TPBody, TPCallout, Badge, Chip */
...
function MetaWhatThisIsNot() {
  const topic = {
    ...
    prev: { n: "11", title: "The Moving-Throat PDE" },
    next: { n: "13", title: "Glossary & Notation" },
  };
    ...
    <TopicPage track="technical" topic={topic} meta>
      <section style={{ padding: "10px 0 40px" }}>
        ...
        <TPLede>
          ...
          Fluid Universe program. If you take away only one thing, take away
      ...
      >
        <TPBody>
          ...
          places the Fluid Universe picture is most exposed.
        </TPBody>
