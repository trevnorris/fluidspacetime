...
function PlainDefects() {
  const topic = {
    ...
    prev: { title: "01 · The Universe as a Fluid" },
    next: { title: "03 · A Hidden Direction" },
  };
    ...
    <TopicPage track="plain" topic={topic}>
      ...
      <TPSection anchor="types" eyebrow="the family" heading="Three kinds of stubborn.">
        <TPBody>
          ...
          ones the Fluid Universe program cares about most share a property:
      ...
      <TPSection anchor="count" eyebrow="counting" heading="Defects carry a number — and that number never changes.">
        ...
        <TPBody>
          ...
          them to disappear. In the Fluid Universe picture, this is the
...
Object.assign(window, { PlainDefects });
