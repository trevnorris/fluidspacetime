...
function PlainHiddenDirection() {
  const topic = {
    ...
    prev: { title: "02 · Defects — When Perfection Breaks" },
    next: { title: "04 · Throats — Defects That Connect" },
  };
    ...
    <TopicPage track="plain" topic={topic}>
      <section style={{ padding: "10px 0 40px" }}>
        ...
        <TPLede>
          ...
          In the Fluid Universe picture, the answer is that our familiar 3D
...
Object.assign(window, { PlainHiddenDirection });
