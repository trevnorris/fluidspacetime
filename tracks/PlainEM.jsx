...
function PlainEM() {
  const topic = {
    ...
    prev: { title: "05 · Gravity as Inflow" },
    next: { title: "07 · Plasma & Magnetohydrodynamics" },
  };
      ...
      <TPSection anchor="next" eyebrow="up next" heading="Coming up: when you have many charged throats.">
        ...
        <div style={{
          ...
          <span className="fu-small" style={{ color: "var(--ink-2)", flex: 1, minWidth: 220 }}>
            Localized 4+1 Maxwell, the profile <em>Z(w)</em>, and why <em>q_eff = q_* / √Z_int</em>.
          </span>
