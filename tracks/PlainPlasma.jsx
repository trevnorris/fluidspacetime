...
function PlainPlasma() {
  const topic = {
    ...
    prev: { title: "06 · Electromagnetism as Puncture" },
    next: { title: "08 · Light, Waves & the Speed Limit" },
  };
  ...
  return (
    <TopicPage track="plain" topic={topic}>
      ...
      <TPSection anchor="where" eyebrow="where MHD breaks" heading="Real plasmas do things MHD says they can't.">
        ...
        <TPBody>
          The Fluid Universe program has a specific story about where those
      ...
      <TPSection anchor="caveats" eyebrow="honest caveats" heading="Where we stand.">
        ...
        <div style={{
          ...
          <span className="fu-small" style={{ color: "var(--ink-2)", flex: 1, minWidth: 220 }}>
            Multi-species projected continuity, the mixed-EM stress tensor, and open projection/topology stress.
          </span>
...
Object.assign(window, { PlainPlasma });
